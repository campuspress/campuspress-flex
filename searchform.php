...
<form method="get" id="<?php echo esc_attr( $args['id'] ); ?>" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
	...
	<div class="input-group">
		<input class="field form-control" id="<?php echo esc_attr( $args['id'] . '-s' ); ?>" name="<?php echo esc_attr( $args['id'] . '-s' ); ?>" type="text" placeholder="<?php esc_attr_e( 'Search...', 'cpschool' ); ?>" value="<?php the_search_query(); ?>">
