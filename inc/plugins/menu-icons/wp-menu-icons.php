	...
	class WPMI {
		...
		function get_icons() {
			$icons = array(
				...
				'cps-icon cps-icon-sort-alpha-asc',
				'cps-icon cps-icon-sort-alpha-desc',
				'cps-icon cps-icon-gift1',
				'cps-icon cps-icon-plane',
				'cps-icon cps-icon-calendar1',
				'cps-icon cps-icon-comment1',
				'cps-icon cps-icon-twitter-square',
				'cps-icon cps-icon-facebook-square',
				'cps-icon cps-icon-key',
				'cps-icon cps-icon-linkedin-square',
				'cps-icon cps-icon-facebook',
				'cps-icon cps-icon-facebook-f',
				'cps-icon cps-icon-bell-o',
				'cps-icon cps-icon-chain',
				...
				'cps-icon cps-icon-address-card-o',
